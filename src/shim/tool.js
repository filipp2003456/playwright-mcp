...
function load() {
  ...
  const fs = require("fs");
  const candidates = [
    "lib/mcp/browser/tools/tool.js",
    "lib/server/mcp/tools/tool.js",
    "lib/mcp/tools/tool.js"
  ];
  ...
  throw new Error("Unable to locate Playwright MCP tool helpers. Update shim with new path.");
}
