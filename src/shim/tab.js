...
function load() {
  ...
  const fs = require("fs");
  const candidates = [
    "lib/mcp/browser/tab.js",
    "lib/server/mcp/tab.js",
    "lib/mcp/tab.js"
  ];
  ...
  throw new Error("Unable to locate Playwright MCP tab module. Update shim with new path.");
}
